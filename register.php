...
<div class="min-h-screen bg-gray-900 flex items-center justify-center p-6">
  <form class="bg-gray-800 p-8 rounded-2xl shadow-lg w-full max-w-md">
    <h2 class="text-2xl font-bold text-gray-100 mb-6 text-center">Inscription</h2>
    
    <label class="block text-gray-300 mb-2">Nom complet</label>
    <input type="text" placeholder="John Doe" class="w-full p-3 rounded-xl bg-gray-700 text-white mb-4 outline-none focus:ring-2 focus:ring-yellow-500">
